...
class _UnicodeFixture(_LiteralRoundTripFixture, fixtures.TestBase):
    ...
    data = (
        "Alors vous imaginez ma ðŸ surprise, au lever du jour, "
        "quand une drÃ´le de petite ðŸ voix mâ€™a rÃ©veillÃ©. Elle "
        "disait: Â« Sâ€™il vous plaÃ®tâ€¦ dessine-moi ðŸ un mouton! Â»"
    )
    ...
    def test_literal_non_ascii(self, literal_round_trip):
        literal_round_trip(self.datatype, ["rÃ©veðŸ illÃ©"], ["rÃ©veðŸ illÃ©"])
    ...
    def test_array_roundtrip(self, connection):
        ...
        connection.execute(
            array_table.insert(),
            {
                "id": 1,
                "single_dim": [1, 2, 3],
                "multi_dim": [["one", "two"], ["thr'ee", "rÃ©veðŸ illÃ©"]],
            },
        )
        row = connection.execute(
            select(array_table.c.single_dim, array_table.c.multi_dim)
        ).first()
        eq_(row, ([1, 2, 3], [["one", "two"], ["thr'ee", "rÃ©veðŸ illÃ©"]]))
...
class TextTest(_LiteralRoundTripFixture, fixtures.TablesTest):
    ...
    def test_literal_non_ascii(self, literal_round_trip):
        literal_round_trip(Text, ["rÃ©veðŸ illÃ©"], ["rÃ©veðŸ illÃ©"])
...
class StringTest(_LiteralRoundTripFixture, fixtures.TestBase):
    ...
    @requirements.unicode_data_no_special_types
    def test_literal_non_ascii(self, literal_round_trip):
        literal_round_trip(String(40), ["rÃ©veðŸ illÃ©"], ["rÃ©veðŸ illÃ©"])
...
class EnumTest(_LiteralRoundTripFixture, fixtures.TablesTest):
    ...
    enum_values = "a", "b", "a%", "b%percent", "rÃ©veillÃ©"
    ...
    def test_round_trip_executemany_returning(self, connection):
        ...
        eq_(result.scalars().all(), ["b%percent", "rÃ©veillÃ©", "b", "a%"])
