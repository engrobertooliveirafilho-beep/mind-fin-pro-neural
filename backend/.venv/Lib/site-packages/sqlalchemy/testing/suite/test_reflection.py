...
class ComponentReflectionTest(ComparesTables, OneConnectionTablesTest):
    ...
    def test_comments_unicode(self, connection, metadata):
        Table(
            "unicode_comments",
            metadata,
            Column("unicode", Integer, comment="Ã©è©¦è›‡áºŸÎ©"),
            Column("emoji", Integer, comment="â˜ï¸âœ¨"),
            comment="è©¦è›‡áºŸÎ©âœ¨",
        )
    ...
    def test_comments_unicode_full(self, connection, metadata):
        Table(
            "unicode_comments",
            metadata,
            Column("emoji", Integer, comment="ðŸðŸ§™ðŸðŸ§™â€â™‚ï¸ðŸ§™â€â™€ï¸"),
            comment="ðŸŽ©ðŸ°ðŸ‘ðŸ¤·â€â™€ï¸ðŸ¤·â€â™‚ï¸",
        )
        ...
        insp = inspect(connection)
        tc = insp.get_table_comment("unicode_comments")
        eq_(tc, {"text": "ðŸŽ©ðŸ°ðŸ‘ðŸ¤·â€â™€ï¸ðŸ¤·â€â™‚ï¸"})
        c = insp.get_columns("unicode_comments")[0]
        eq_({c["name"]: c["comment"]}, {"emoji": "ðŸðŸ§™ðŸðŸ§™â€â™‚ï¸ðŸ§™â€â™€ï¸"})
